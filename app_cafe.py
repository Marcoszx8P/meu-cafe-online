...
# 3. Execução e Exibição dos Preços
...
# 4. Seção Explicativa (Agora abaixo dos preços)
st.divider()
...
with exp_col2:
    ...
    st.write("Monitoramento em tempo real de NY e Dólar.")
with exp_col3:
    st.markdown("**3. Alvo Estimado**")
    st.write("Previsão baseada na oscilação do mercado.")

st.info("⚠️ **Aviso de Versão Beta:** Este site está em fase de testes. Os valores são estimativas matemáticas.")

# 5. Créditos (O Gran Finale)
st.markdown("<br><br>", unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: #4E342E;'>Criado por: Marcos Gomes</h1>", unsafe_allow_html=True)
